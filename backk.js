...
function Home() {
    return ( <
        ...
        /> <
        ReactImage source = { require('./assets/x45.png') }
        style = { styles.homeimg }
        /> <
        View style = { styles.placeholderletter }
        /> <
        ReactImage source = { require('./assets/pawprintf75206ca.png') }
        ...
        View style = { styles.placeholderletter }
        /> <
        ReactImage source = { require('./assets/pawprint77785d18.png') }
        style = { styles.pawprinthome }
        /> <
        ReactImage source = { require('./assets/istock1098033974.png') }
        style = { styles.homeimg }
        /> <
        ...
        View style = { styles.placeholderletter }
        /> <
        ReactImage source = { require('./assets/pawprint6ece8c81.png') }
        style = { styles.pawprinthome }
        /> <
        ReactImage source = { require('./assets/istock1199449447.png') }
        style = { styles.homeimg }
        /> <
...
function Petcaretips() {
    return ( <
        ...
        /> <
        ReactImage source = { require('./assets/care.png') }
        ...
        1. Brush Your Cat Every Day 2. Don’ t Feed Your Cat Too Much Dry Food 3. Pay Attention to Your Pet’ s Thirst 4. Provide a Sufficient Number of Litter Boxes 5. Don’ t Assume You Know Why a Cat Is Peeing Outside the Box 6. Train Your Cat to Use a Scratching Post 7. Spay or Neuter Your Cat 8. Travel Safely With Your Pet 9. Choose a Cat -
        Friendly Vet 10. Let Them Show Off!
        <
        /Text> <
        /Text> <
        /View> <
        ...
        1. Regular Exams are Vital .2.Spay and Neuter Your Pets .3.Prevent Parasites .4.Maintain a Healthy Weight .5.Get Regular Vaccinations .6.Provide an Enriched Environment .7.Pets Need Dental Care, Too .8.Provide a Protected and Clean Living Environment For Your Dog .9.Always Keep Fresh Water Available .10.Feed a Quality Diet and Prevent Obesity .11.Have your Pet Examined by a Veterinarian on a Regular Basis .12.Provide Ample Opportunities to Exercise .13.Communicate with your Dog and Develop a Relationship .14.Train your dog to Follow the Simple Commands .15.Practice Reproductive Control .16.Dental care is very important .17.Don 't Overlook
        Grooming and Nail Trimming. <
        /Text> <
        /Text> <
        /View> <
        Text style = { styles.petsubtitleforother } >
        Helping you to take good care of your pets by providing these simple tips!
        <
        /Text> <
        /ScrollView>
    );
...
function Pettrivia() {
    return ( <
        ...
        View style = { styles.group235pinkrectangle }
        /> <
        ReactImage source = { require('./assets/trivia.png') }
        style = { styles.grp235img }
        /> <
        ...
        1. Cats sleep
        for around 13 to 16 hours a day(70 % of their life).Have you ever noticed that cats are always sleeping ? They do
            this to save their energy.In the wild they would be saving their
        energy to go and hunt
        for their food.House cats obviously don’ t need to do this but it just comes naturally to them .2.In 1963 a cat
        went to space You’ ve heard of monkeys and dogs in space, but did you know that a cat braved the great unknown too ? On October 18 th 1963 Felicette, also known as‘ Astrocat’ was the first and only cat to go to space .3.Ancient Egyptians would shave off their eyebrows when their cats died According to Ancient History Encyclopedia,
        Herodotus wrote in 440 BC that when a pet cat died in Ancient Egyptian times the family members would shave off their eyebrows in
        mourning.Now that’ s an interesting cat fact!
        <
        /Text> <
        /View> <
        /View> <
        ...
        <
        Text style = { styles.info } >
        1. Speaking of sleeping… all dogs dream, but puppies and senior dogs dream more frequently than adult dogs .2.A dog’ s sense of smell is legendary, but did you know that his nose has as many as 300 million receptors ? In comparison, a human nose has about 5 million .3.Dogs’ noses can sense heat / thermal radiation, which explains why blind or deaf dogs can still hunt. { ' ' } <
        /Text> <
        /View> <
        /View> <
        Text style = { styles.petsubtitleforother } >
        Interesting trivias about your pets that will amaze and help you to understand and love them more!{ ' ' } <
        /Text> <
        /ScrollView>
    );
}
...
function Catbreeds() {
    return ( <
        ...
        <
        Svg style = { styles.maincoonplaceholder }
        ...
        The classic Maine coon coloration is a brown tabby, but this breed can come in almost any color.Breed Overview Height: Up to 16 inches.Weight: 8 to 20 pounds. { ' ' } <
        /Text> <
        Svg style = { styles.catpiccircle }
        fill = "rgba(255, 255, 255, 1)"
        preserveAspectRatio = "none"
        ...
        Defs >
        <
        Pattern id = "img-maincoon"
        patternContentUnits = "userSpaceOnUse"
        width = "100%"
        height = "100%" >
        <
        SvgImage xlinkHref = { require('./assets/mainecoon.png') }
        x = "0"
        y = "0"
        width = "152.00px"
        height = "152.00px" /
        ...
        /Pattern> <
        /Defs> <
        SvgPath d = "M 76 0 C 117.9736328125 0 152 34.02636337280273 152 76 C 152 117.9736328125 117.9736328125 152 76 152 C 34.02636337280273 152 0 117.9736328125 0 76 C 0 34.02636337280273 34.02636337280273 0 76 0 Z"
        ...
        <
        Svg style = { styles.siameseplaceholder }
        preserveAspectRatio = "none"
        ...
        Popular since the 19 th century, this cat breed originated in
        Thailand(formerly known as Siam).The Siamese has been a foundational breed
        for the Oriental shorthair, sphynx, and Himalayan.Most Siamese cats have distinct markings called "points"
        that are the areas of coloration on their face, ears, feet, and tail. { ' ' } <
        /Text> <
        Svg style = { styles.catpiccircle }
        preserveAspectRatio = "none"
        viewBox = "-0.75 -0.75 153.5 153.5"
        ...
        Defs >
        <
        Pattern id = "img-siamese"
        patternContentUnits = "userSpaceOnUse"
        width = "100%"
        height = "100%" >
        <
        SvgImage xlinkHref = { require('./assets/siamese.png') }
        x = "0"
        y = "0"
        width = "152.00px"
        height = "152.00px" /
        ...
        <
        Svg style = { styles.iranianshirazplaceholder }
        preserveAspectRatio = "none"
        ...
        Also lovingly referred to as one of the "smushed-face"
        cats, the Iranian cat or Shiraz cat(named
            for a city in Iran), Persians have beautiful, long fur coats.They can come in almost any color and have a flat face when compared to most other breeds of cats.Persians are featured in many movies, artworks, and commercials and have been one of the most popular breeds of cats
        for decades HEIGHT: 14 to 18 inches WEIGHT: 7 to 12 pounds COAT AND COLOR: Long coat in
        solid(white, black, cream), tabby, calico, bi - color, silver and gold, shaded, and smoke LIFE EXPECTANCY: 15 to 20 years { ' ' } <
        /Text> <
        Svg style = { styles.catpiccircle }
        preserveAspectRatio = "none"
        viewBox = "-0.75 -0.75 153.5 153.5"
        ...
        <
        Pattern id = "img-shiraz"
        patternContentUnits = "userSpaceOnUse"
        width = "100%"
        height = "100%" >
        <
        SvgImage xlinkHref = { require('./assets/shiraz.png') }
        x = "0"
        y = "0"
        width = "152.00px"
        height = "152.00px" /
        ...
        <
        Svg style = { styles.persianplaceholder }
        preserveAspectRatio = "none"
        ...
        Persians are featured in many movies, artworks, and commercials and have been one of the most popular breeds of cats
        for decades. { ' ' } <
        /Text> <
        ...
        Defs >
        <
        Pattern id = "img-persian"
        patternContentUnits = "userSpaceOnUse"
        width = "100%"
        height = "100%" >
        <
        SvgImage xlinkHref = { require('./assets/persian.png') }
        x = "0"
        y = "0"
        width = "152.00px"
        height = "152.00px" /
        ...
        <
        Svg style = { styles.ragdolldplaceholder }
        preserveAspectRatio = "none"
        ...
        Ragdoll cats get their name from their docile temperament.They tend to go limp when picked up, much like a rag doll.At one time, people thought they couldn’ t feel pain, but that is not true.Ragdolls look a lot like long - haired Siamese cats with pointed color patterns.They also have distinctive blue eyes and dog - like personalities, following their owners around the house.HEIGHT: 11 to 13 inches WEIGHT: 15 to 20 pounds COAT AND COLOR: Medium - length and silky with many different colors and patterns with blue eyes LIFE EXPECTANCY: 15 to 25 years { ' ' } <
        /Text> <
        Svg style = { styles.catpiccircle }
        preserveAspectRatio = "none"
        viewBox = "-0.75 -0.75 153.5 153.5"
        ...
        <
        Pattern id = "img-ragdoll"
        patternContentUnits = "userSpaceOnUse"
        width = "100%"
        height = "100%" >
        <
        SvgImage xlinkHref = { require('./assets/ragdoll.png') }
        x = "0"
        y = "0"
        width = "152.00px"
        height = "152.00px" /
        ...
        <
        Svg style = { styles.bengalsplaceholder }
        preserveAspectRatio = "none"
        ...
        Bengals are wild - looking cats— literally.Their markings make them look more like they belong in the jungle rather than in your home,
        but they are domesticated.They are talkative and require a lot of exercise.They come in many colors with patterns like spots and rosettes.Their name comes from the Asian leopard cat’ s taxonomic name, Prionailurus bengalensis bengalensis.Bengals were initially bred from domestic cats and a wildcat.They also get their beautiful patterns from this wildcat.HEIGHT: 13 to 16 inches WEIGHT: 6 to 12 pounds COAT AND COLOR: Shorthaired, spotted, or marbled coat with patterns in black, chocolate, or gray / silver with green or gold eyes LIFE EXPECTANCY: 12 to 15 years { ' ' } <
        /Text> <
        Svg style = { styles.catpiccircle }
        preserveAspectRatio = "none"
        viewBox = "-0.75 -0.75 153.5 153.5"
        ...
        Defs >
        <
        Pattern id = "img-bengal"
        patternContentUnits = "userSpaceOnUse"
        width = "100%"
        height = "100%" >
        <
        SvgImage xlinkHref = { require('./assets/bengal.png') }
        x = "0"
        y = "0"
        width = "152.00px"
        height = "152.00px" /
        ...
        <
        Svg style = { styles.birmanplaceholder }
        preserveAspectRatio = "none"
        ...
        Birmans are another color - pointed cat like the Siamese and ragdoll.They have blue eyes and a medium - long coat but no undercoat, the primary trait that sets them apart from Persians and Himalayans.Birmans were the original stock
        for breeding ragdolls, so they look very similar, but they have slightly different markings and personalities.They are fun, social cats that love attention— from their chosen person.They are more of a one - person cat than others.HEIGHT: 8 to 10 inches WEIGHT: 6 to 15 pounds COAT AND COLOR:
        Long and silky coat in seal, blue, red, chocolate, cream, and tortie colors, including standard or lynx pattern points and deep blue eyes LIFE EXPECTANCY: 15 to 20 years { ' ' } <
        /Text> <
        Svg style = { styles.catpiccircle }
        preserveAspectRatio = "none"
        viewBox = "-0.75 -0.75 153.5 153.5"
        ...
        <
        Pattern id = "img-birman"
        patternContentUnits = "userSpaceOnUse"
        width = "100%"
        height = "100%" >
        <
        SvgImage xlinkHref = { require('./assets/birman.png') }
        x = "0"
        y = "0"
        width = "152.00px"
        height = "152.00px" /
        ...
        <
        Svg style = { styles.orientalShorthairplaceholder }
        preserveAspectRatio = "none"
        ...
        they usually have green eyes and many color patterns and colors.The Oriental can also have long hair.Oriental shorthair cats are prone to skin cancer and getting cold due to their lack of fur; they are often seen wearing sweaters.HEIGHT: 9 to 11 inches WEIGHT: 7 to 12 pounds COAT AND COLOR: Short, smooth coat with many color possibilities: solids, shaded, smoke, and tabby with green, blue,
        ...
        <
        Pattern id = "img-orientalshorthair"
        patternContentUnits = "userSpaceOnUse"
        width = "100%"
        height = "100%" >
        <
        SvgImage xlinkHref = { require('./assets/orientalshorthair.png') }
        x = "0"
        y = "0"
        width = "152.00px"
        height = "152.00px" /
        ...
        <
        Svg style = { styles.sphynxplaceholder }
        preserveAspectRatio = "none"
        ...
        If you are looking
        for a cat that doesn 't shed, then the sphynx is
        for you.Sphynx cats look unique due to their lack of fur and are very social, active, dog - like felines.They look like they belong in the laps of royalty, but they are playful and goofy and act more like court jesters despite their regal appearance.HEIGHT: 8 to 10 inches WEIGHT: 8 to 10 pounds COAT AND COLOR: Hairless with white,
        ...
        <
        Pattern id = "img-sphynx"
        patternContentUnits = "userSpaceOnUse"
        width = "100%"
        height = "100%" >
        <
        SvgImage xlinkHref = { require('./assets/sphynx.png') }
        x = "0"
        y = "0"
        width = "152.00px"
        height = "152.00px" /
        ...
        <
        Svg style = { styles.devonRexplaceholder }
        preserveAspectRatio = "none"
        ...
        Devon rex cats have wavy, soft short hair and slender bodies with enormous ears.The Devon Rex is a playful, active cat described as "a
        monkey in a catsuit.
        " This kitty will steal your heart with its
        lively, sweet disposition.They are also trainable and adept at learning tricks.HEIGHT: 10 to 12 inches WEIGHT: 7 to 12 pounds COAT AND COLOR: Short, fine, wavy coat in solid, tabby, and shaded varieties LIFE EXPECTANCY: 15 to 20 years { ' ' } <
        /Text> <
        Svg style = { styles.catpiccircle }
        preserveAspectRatio = "none"
        viewBox = "-0.75 -0.75 153.5 153.5"
        ...
        Defs >
        <
        Pattern id = "img-devonrex"
        patternContentUnits = "userSpaceOnUse"
        width = "100%"
        height = "100%" >
        <
        SvgImage xlinkHref = { require('./assets/devonrex.png') }
        x = "0"
        y = "0"
        width = "152.00px"
        height = "152.00px" /
        ...
        /> <
        ReactImage source = { require('./assets/catpic.png') }
        style = { styles.catbreedsfinal_group235_image4 }
        /> <
        Text style = { styles.catbreedsfinal_group235_catBreeds } >
        Cat Breeds <
        /Text> <
        /View> <
        /ScrollView>
...
function Dogbreeds() {
    return ( <
            ...
            View style = { styles.group235pinkrectangle }
            /> <
            ReactImage source = { require('./assets/image4.png') }
            style = { styles.grp235img }
            /> <
            ...
            The Rhodesian ridgeback likely originated from Khoikhoi dogs native to southern Africa.When European settlers arrived in the 16 th century, they bred their own dogs with these hunting dogs to create a breed that would fare well in extreme temperatures and be fiercely loyal.Dog Breed Group: Hound Dogs; Height: 24 to 27 inches tall at the shoulder; Weight: 70 to 85 pounds; Life Span: 10 to 12 years Color: Red Wheaten, Light Wheaten, Wheaten { ' ' } <
            /Text> <
            ...
            Defs >
            <
            Pattern id = "img-rhodesian"
            patternContentUnits = "userSpaceOnUse"
            width = "100%"
            height = "100%" >
            <
            SvgImage xlinkHref = { require('./assets/rhodesian.png') }
            x = "0"
            y = "0"
            width = "152.00px"
            height = "152.00px" /
            ...
            Bichon Frises originated from the Bichon Tenerife, a breed named after a Spanish island.Historians have suggested that the dogs accompanied Spanish sailors during their travels and could have been used
            for bartering.Between the 14 th and 15 th centuries, Bichon Frises became wildly popular in Italy and France, especially among nobility and middle - class merchants Height: 9.5 to 11.5 inches.Coat: Curly, fluffy.Color: White.Life expectancy: 15 + years. { ' ' } <
            /Text> <
            Svg style = { styles.catpiccircle }
            preserveAspectRatio = "none"
            viewBox = "-0.75 -0.75 153.5 153.5"
            ...
            Origins: Belgium As its name suggests, the Belgian malinois originated in the northwest region of Belgium, around the city of Malines.These dogs were first bred to be livestock herders and were the preferred dog breed
            for Belgian sheepherders and cattlemen.The Belgian Malinois is an enthusiastic and quick dog with a natural tendency to be in motion.Males are 24 to 26 inches tall and weigh 55 to 75 pounds(25 to 34 kilograms).Females are 22 to 24 inches and weigh 40 to 60 pounds(18 to 27 kilograms).Color: fawn - colored,
            red, or brown { ' ' } <
            /Text> <
            Svg style = { styles.catpiccircle }
            preserveAspectRatio = "none"
            ...
            Origins: Great Britain While we know little about how collies came to exist, the breed was used as a sheepdog in the Scottish Highlands in the 18 th century.Collies are more often associated with England:
            the breed rose to prominence south of Scotland after collies were featured at an 1860 dog show in Birmingham.Males stand 24 to 26 inches tall; females are 22 to 24 inches tall.Collies weigh 50 to 70 pounds.Life Span: 10 - 14 years Color: Sable and White, Mahogany Sable, Dark Mahogany Sable, Sable Headed White, Blue Merle, Blue Headed White, Sable Merle, Tri Sable Merle, Tri Color, Tri Headed White, White Factored, White Factored Broken Pattern { ' ' } <
            /Text> <
            Svg style = { styles.catpiccircle }
            preserveAspectRatio = "none"
            viewBox = "-0.75 -0.75 153.5 153.5"
            ...
            Origins: France and Belgium“ Basset” comes from the French word
            for low, which makes sense given how the basset hound 's ears and body
            hang low to the ground.The breed can trace its origins to France and Belgium, where many believe the friars at the Abbey of St.Hubert crossed strains of French breeds to create a dog that was close to the ground, so it could better track rabbit and deer.Weight Range:
            Male: 40 - 60 lbs.Female: 40 - 60 lbs.Height at Withers: Male: 14 in
            .Female: 13 in . { ' ' } <
            /Text> <
            Svg style = { styles.catpiccircle }
            preserveAspectRatio = "none"
            ...
            Defs >
            <
            Pattern id = "img-basset"
            patternContentUnits = "userSpaceOnUse"
            width = "100%"
            height = "100%" >
            <
            SvgImage xlinkHref = { require('./assets/basset.png') }
            x = "0"
            y = "0"
            width = "152.00px"
            height = "152.00px" /
            ...
            Origins: Malta There are numerous theories about how the Maltese breed came to be.One speculates that these pip - squeak dogs are descended from a Swedish Spitz - type dog.Another posits that they originated from the Tibetan terriers of Asia.Height: 8 to 10 inches tall at the shoulder Weight: Up to 7 pounds Life Span: 12 - 15 years Color: White { ' ' } <
            /Text> <
            Svg style = { styles.catpiccircle }
            preserveAspectRatio = "none"
            viewBox = "-0.75 -0.75 153.5 153.5"
            ...
            Origins: Chihuahua, Mexico As its name suggests, Chihuahuas were developed in the Chihuahua region of Mexico, the largest of the country 's states. According to historians, American tourists took
            an interest in the tiny pup in the 1800 s, often bringing the dogs back to the United States.Dog Breed Group: Companion Dogs; Height: 6 inches to 9 inches tall at the shoulder; Weight: 3 to 6 pounds; Life Span: 10 to 18 years.Color: black, black & tan, fawn, fawn & white,
            blue & tan, cream, chocolate, chocolate & tan, and red. { ' ' } <
            /Text> <
            Svg style = { styles.catpiccircle }
            preserveAspectRatio = "none"
            viewBox = "-0.75 -0.75 153.5 153.5"
            ...
            Origins: Hungary Vizslas call Hungary home.There, they were originally the prized hunting dogs of the Magyar tribe in the 8 th century.Historians have even found ancient stone etchings featuring Vizslas and their prey.The breed declined as the years wore on,
            however, and after World War II, when Russia occupied Hungary, many feared that the breed would be completely eradicated, since owning a Vizsla was a symbol of royalty. { ' ' } <
            /Text> <
            Svg style = { styles.catpiccircle }
            preserveAspectRatio = "none"
            viewBox = "-0.75 -0.75 153.5 153.5"
            ...
            Defs >
            <
            Pattern id = "img-vizsla"
            patternContentUnits = "userSpaceOnUse"
            width = "100%"
            height = "100%" >
            <
            SvgImage xlinkHref = { require('./assets/vizsla.png') }
            x = "0"
            y = "0"
            width = "152.00px"
            height = "152.00px" /
            ...
            Origins: Great Britain The name of this breed comes from the fact that border collies were first developed on the border between England and Scotland, in an area called Northumberland.Border collies, which were originally used
            for herding sheep, were officially recognized as a breed in 1915
            for the purpose of distinguishing the dogs from other collie breeds.height18 to 22 inchesweight30 to 55 poundslife span12 to 15 yearsbreed sizemedium(26 - 60 lbs Color: Standard colors are black, blue, blue merle, brindle, gold, lilac, red, red merle, sable, sable merle,
                saddleback sable, white and black, white and blue, white and blue merle, white and red, white and red merle, and white ticked. { ' ' } <
                /Text> <
                Svg style = { styles.catpiccircle }
                preserveAspectRatio = "none"
                viewBox = "0 0 152 152"
                ...
                height = "100%" >
                <
                SvgImage xlinkHref = { require('./assets/bordercollie.png') }
                x = "0"
                y = "0"
                width = "152.00px"
                height = "152.00px" /
                ...
                Origins: Great Britain The enormous mastiff has been popular around the world
                for centuries, but the dogs we know today— sometimes called“ Old English mastiffs”— trace their roots back to Great Britain.When Julius Caesar invaded Great Britain in 55 B.C., he was reportedly taken aback by the size and strength of the mastiffs in
                the area and brought back several to Rome to fight wild beasts and gladiators .27 .5 - 30 + inchesweight120 - 230 pounds life span6 -
                10 years breed size extra large(101 lbs.or more Color: Brindle,
                    Fawn, Apricot { ' ' } <
                    /Text> <
                    Svg style = { styles.catpiccircle }
                    preserveAspectRatio = "none"
            ...
            function MyTabs() {
                return ( <
                    ...
                    component = { Petcaretips }
                    options = {
                        {
                            tabBarLabel: 'Pet Care Tips',
                    ...
                    /> <
                    Tab.Screen name = "Trivia"
                    component = { Pettrivia }
                    options = {
                        {
                            tabBarLabel: 'Pet Trivia',
                            tabBarIcon: ({ color, size }) => ( <
                                Ionicons name = "home"
                                color = { color }
                                size = { size }
                    ...
                    /> <
                    Tab.Screen name = "Cat Breeds"
                    component = { Catbreeds }
                    options = {
                        {
                            tabBarLabel: 'Cat Breeds',
                            tabBarIcon: ({ color, size }) => ( <
                                Ionicons name = "home"
                                color = { color }
                                size = { size }
                    ...
                    /> <
                    Tab.Screen name = "Dog Breeds"
                    component = { Dogbreeds }
                    options = {
                        {
                            tabBarLabel: 'Dog Breeds',
                            tabBarIcon: ({ color, size }) => ( <
                                Ionicons name = "home"
                                color = { color }
                                size = { size }
